...
var html = _test2.default.render({ message: 'world' });
...
(function() {(nunjucks.nunjucksPrecompiled = nunjucks.nunjucksPrecompiled || {})["public/templates/test.njk"] = (function() {
...
output += "<h1>Hello ";
output += runtime.suppressValue(env.getFilter("default").call(context, runtime.contextOrFrameLookup(context, frame, "message"),"world"), env.opts.autoescape);
output += "</h1>";
if(parentTemplate) {
...
module.exports = shim(nunjucks, env, nunjucks.nunjucksPrecompiled["public/templates/test.njk"] , dependencies)
